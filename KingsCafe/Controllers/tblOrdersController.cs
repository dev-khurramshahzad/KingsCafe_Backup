...
namespace KingsCafe.Controllers
{
    public class tblOrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ORDER_ID,ORDER_CUSTOMER_NAME,ORDER_CUSTOMER_ADDRESS,ORDER_CUSTOMER_CONTACT,CUSTOMER_FID,ORDER_STATUS,ORDER_DATE")] tblOrder tblOrder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ORDER_ID,ORDER_CUSTOMER_NAME,ORDER_CUSTOMER_ADDRESS,ORDER_CUSTOMER_CONTACT,CUSTOMER_FID,ORDER_STATUS,ORDER_DATE")] tblOrder tblOrder)
        {
            if (ModelState.IsValid)
            {
